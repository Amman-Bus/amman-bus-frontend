...
function MainPage(props) {
  ...
  React.useEffect(() => {
    ...
    window.addEventListener('scroll', () => {
      ...
      // if (threshold < section5.offsetTop) 
      // {
      //   triggerShowHideSection(section5, 'hide')
      // } else {
      //   triggerShowHideSection(section5, 'show')
      // } 
  ...
  return (
    <div id="mainPage" className="w-full h-fit">
        ...
        <div id='divider5' style={{textShadow: "5px 5px 8px #FFF"}}  
            className='opacity-100 border-t-4 border-gray-700 w-full h-fit flex justify-center items-center p-20 mt-20'>
                <div className='w-full font-bold text-primary-top text-4vw font-russo opacity-75 text-center leading-tight tracking-wider'>
                Contact Us
                </div>
        </div>
